const client = contentful.createClient({
    ...
    accessToken: "TXRJf88dkqAvNyGnZbBbI8jgisq0Ufe662V9wbPkcks"
});
...
class UI {
    ...
    addCartItem(item) {
        ...
        div.innerHTML = `<img src=${item.image} alt="product" class="product-img">
                    <div>
                        <h4>${item.title}</h4>
                        <h5>$${item.price}</h5>
